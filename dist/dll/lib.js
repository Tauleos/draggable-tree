    ...
    n.r(e),
      function(t, n) {
        ...
        var z,
          ...
          Y = (G && G.indexOf("android"),
          (G && /iphone|ipad|ipod|ios/.test(G)) || "ios" === X),
          tt = (G && /chrome\/\d+/.test(G),
          G && /phantomjs/.test(G),
          G && G.match(/firefox\/(\d+)/)),
          et = {}.watch,
          nt = !1;
        ...
        function Ze(t, e, n) {
          (Be = t), ae(e, n || {}, Ke, Xe, Ge, t), (Be = void 0);
        }
        var Je = null;
        function Qe(t) {
          var e = Je;
          ...
          t.prototype._init = function(t) {
            ...
            (e._uid = $n++),
              ...
              t && t._isComponent
                ...
                : (e.$options = Lt(An(e.constructor), t || {}, e)),
              (e._renderProxy = e),
              (e._self = e),
              (function(t) {
                var e = t.$options,
        ...
        var Mr,
          ...
          Fr = function(t, e, n) {
            if (Lr.test(e)) t.style.setProperty(e, n);
              ...
              t.style.setProperty(O(e), n.replace(Nr, ""), "important");
            else {
              var r = Ur(e);
              if (Array.isArray(n))
            ...
            if (!k || w || "" === w) {
              ...
              var N = !1 !== a && !J,
                ...
                R = (n._enterCb = L(function() {
                  N && (oo(n, E), oo(n, T)),
                    R.cancelled ? (N && oo(n, S), P && P(n)) : D && D(n),
                    (n._enterCb = null);
                }));
              t.data.show ||
                ...
                N &&
                  ...
                  no(function() {
                    oo(n, S),
                      R.cancelled ||
                        (ro(n, E),
                        F || (po(M) ? setTimeout(R, M) : io(n, s, R)));
                  })),
        ...
        var Io = function(t) {
          ...
          Po = T({ tag: String, moveClass: String }, ko);
        function Mo(t) {
